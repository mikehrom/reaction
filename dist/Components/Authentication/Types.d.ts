...
export declare type SubmitHandler = (values: InputValues, formikBag: FormikProps<InputValues>) => void;
...
export declare type FormComponentType = React.SFC<FormProps> | React.ComponentClass<FormProps>;
export {};
