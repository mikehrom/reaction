...
exports.MobileForgotPasswordForm = void 0;
...
var MobileForgotPasswordForm =
/*#__PURE__*/
function (_React$Component) {
  _inherits(MobileForgotPasswordForm, _React$Component);

  function MobileForgotPasswordForm() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, MobileForgotPasswordForm);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MobileForgotPasswordForm)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(MobileForgotPasswordForm, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_formik.Formik, {
        ...
        return _react.default.createElement(_commonElements.MobileContainer, null, _react.default.createElement(_commonElements.MobileInnerWrapper, null, _react.default.createElement(_commonElements.FormContainer, {
          ...
          height: 270
        }, _react.default.createElement(_commonElements.MobileHeader, null, "Reset your password"), _react.default.createElement(_QuickInput.default, {
          block: true,
          error: errors.email,
        ...
        }, "Send me reset instructions"), _react.default.createElement(_commonElements.Footer, {
...
exports.MobileForgotPasswordForm = MobileForgotPasswordForm;
