export declare type ArticleLayout = "classic" | "feature" | "series" | "standard" | "video" | "news";
export declare enum ArticleAdType {
    Feature = "feature",
    Article = "article",
...
export declare enum AdDimension {
...
export declare type SectionLayout = "blockquote" | "column_width" | "fillwidth" | "full" | "mini" | "overflow_fillwidth";
export declare type BylineLayout = "fullscreen" | "condensed" | "standard" | "split";
export declare type DateFormat = "condensed" | "monthYear" | "monthDay" | "news" | "verbose" | "default";
...
export declare type SectionType = "image_collection" | "image" | "image_set" | "embed" | "social_embed" | "slideshow" | "text" | "video" | "default";
...
export declare type ImagesData = ImageData[];
