...
exports.NewsArticle = exports.SeriesArticleCustomSubTitle = exports.SeriesArticleSponsored = exports.SeriesArticle = exports.VideoArticleSponsored = exports.VideoArticleUnpublished = exports.VideoArticle = exports.TextFeatureArticle = exports.TextStandardArticle = exports.TextClassicArticle = exports.MissingVerticalStandardArticle = exports.ShortStandardArticle = exports.ImageHeavyStandardArticle = exports.SuperArticle = exports.SponsoredFeatureArticle = exports.SponsoredArticle = exports.FeatureBasicArticle = exports.UnsponsoredFeatureArticle = exports.FeatureBasicVideoArticle = exports.NonSponsoredFeatureArticle = exports.FeatureArticle = exports.BasicArticle = exports.StandardArticle = exports.ClassicArticleManyAuthors = exports.ClassicArticle = void 0;
...
var ClassicArticle = {
  ...
  email_metadata: {
    image_url: "https://artsy-media-uploads.s3.amazonaws.com/wHFgQlrTrHav5O6bQRJ0dg%2FUntitled+Suspended_30x67x33+%282%29_sm+cropped.jpg",
...
exports.ClassicArticleManyAuthors = ClassicArticleManyAuthors;
var StandardArticle = {
  ...
  sections: [{
    ...
    images: [{
      ...
      width: 600,
      height: 1067,
      caption: "<p>John Elisle, <em>The Star</em>, from the reimagined female Tarot cards. Courtesy of the artist. </p>"
    }, {
      url: "https://artsy-media-uploads.s3.amazonaws.com/PcvH_rh89gRGxRXgCyGGng%2Funnamed-5.png",
      type: "image",
      width: 600,
      height: 1067,
      caption: "<p>John Elisle, <em>The Magician</em>, from the reimagined female Tarot cards. Courtesy of the artist. </p>"
    }, {
      type: "artwork",
      id: "596aa2851a1e864d5eea6681",
      slug: "matt-devine-brass-tax",
    ...
    type: "text",
    body: "<p>Created by graphic designer Kati Forner for a Los Angeles-based fashion retailer, the Dreslyn tarot is the epitome of techno-minimalism. Although the deck is lovingly printed with high-gloss embossing, its illustrations are simple enough to be mistaken for the icon of an elegant iPhone app. It’s a radical departure from the historical approach, where each card is full to bursting with details, signs, and symbols—instead, each card has been paired down the bare minimum. The Dreslyn’s Lovers image is just two slender circles bisecting a line; its Eight of Wands is simply eight diagonal rules. The deck’s aesthetic mirrors the contemporary fear of clutter, as well as the increasing simplicity of the interfaces we use every day.</p><p>Tarot decks have also increasingly become more personal, and occasionally political, while reflecting a greater diversity. Illustrator John Elisle, in a commission for Missy Magazine, created seven all-women tarot cards, a chic sci-fi universe that includes a dominatrix Devil and a psychedelic High Priestess.</p>"
  }, {
    type: "image_collection",
    layout: "column_width",
    images: [{
...
var BasicArticle = _objectSpread({}, StandardArticle, {
  ...
  }].concat(_toConsumableArray(StandardArticle.sections)),
  contributing_authors: [// deprecated
  {
    id: "523783258b3b815f7100055a",
    name: "Casey Lesser"
...
exports.BasicArticle = BasicArticle;
var FeatureArticle = {
  ...
  description: "Applying for art prizes can be daunting, but doing so is a pathway to exhibitions, influential contacts, and a way to gain valuable feedback about your work.",
  tier: 1,
  tags: ["Inspiration"],
  ...
  sections: [{
    ...
    type: "text",
    layout: "blockquote",
    body: "<blockquote>Land exhibitions, make influential contacts, and gain valuable feedback about your work.</blockquote>"
  }, {
    type: "image_collection",
    layout: "overflow_fillwidth",
    images: [{
    ...
    type: "text",
    body: "<p>Enthusiastically grow high-payoff infomediaries for virtual methodologies. Competently maximize reliable scenarios whereas magnetic e-services. Completely formulate sticky schemas rather than strategic technologies. Phosfluorescently disseminate long-term high-impact e-services vis-a-vis effective collaboration and idea-sharing. Credibly provide access to technically sound services through plug-and-play niches.</p>"
  }, {
    type: "image_set",
    layout: "mini",
    images: [{
...
var NonSponsoredFeatureArticle = _objectSpread({}, FeatureArticle, {
  sections: [{
    ...
    type: "text",
    body: "<p>I was 14 years old at the time of the riot in June 1969, when patrons of the Stonewall Inn, a mafia-run gay bar in Greenwich Village, fought back against law enforcement’s oppressive bullying. I was living in Montreal, a place that was progressively liberated. Amendments to the Criminal Code to relax laws against homosexuality were proposed by then-Justice Minister Pierre Trudeau in 1967, two years before Stonewall launched gay rights into the spotlight in the United States. The bill to decriminalize homosexuality was passed in Canada in 1969, and likely overshadowed any press of Stonewall in my world. </p><p>Due to my delayed landing in New York in 1972, I’d missed that year’s annual commemoration of Stonewall. In the years that followed, I have memories of throngs of folks gravitating west on the last Sunday in June for the Gay Liberation Marches. I rarely followed. I wasn’t interested in the mob mentality of marches or parades; I preferred avoiding them altogether. <strong><em> </em></strong></p>"
  }, {
    type: "image_collection",
    layout: "overflow_fillwidth",
    images: [{
      url: "https://artsy-media-uploads.s3.amazonaws.com/cudoUvvjlGol3luBvqtUtA%2FHujar-GLF2.jpg",
      caption: "<p>Peter Hujar, <i>Gay Liberation Front Poster, </i>1970. © 1987 The Peter Hujar Archive LLC; Courtesy Pace/MacGill Gallery, New York and Fraenkel Gallery, San Francisco.</p>",
      type: "image",
      width: 1196,
      height: 1780,
      index: 1
    }, {
      url: "https://artsy-media-uploads.s3.amazonaws.com/abZpHhfupMPXkfM-niszCQ%2F07.-Diana-Davies%2C-Gay-Rights-Demonstration%2C-Albany%2C-NY%2C-1971.jpg",
      caption: "<p>Diana Davies,<i> Gay Rights Demonstrations, Albany, NY, </i>1971.<i> </i>© The New York Public Library. </p>",
      type: "image",
      width: 1200,
      height: 1779,
      index: 2
    ...
    layout: "column_width",
    images: [{
      url: "https://artsy-media-uploads.s3.amazonaws.com/E9aSd7E-Yqi39eW53cq3dQ%2FWarhol.jpg",
      caption: "<p>Andy Warhol, <i>Ladies and Gentlemen, </i>1975. © 2018 The Andy Warhol Foundation for the Visual Arts, Inc. / Licensed by Artists Rights Society (ARS), New York.</p>",
      type: "image",
      width: 1400,
      height: 2112,
      index: 3
    ...
    images: [{
      ...
      image: "https://d32dm0rphc51dk.cloudfront.net/BaNXUiAp74GGF6PTKBU1Pg/larger.jpg",
      title: null,
      date: "",
      partner: {
      ...
      url: "https://artsy-media-uploads.s3.amazonaws.com/MEORh5qbS0v8g7tKEO6Log%2FJS0531.jpg",
      caption: "<p>Jack Smith, <i>Untitled</i>, c. 1964–1981. © Jack Smith Archive. Courtesy of Gladstone Gallery, New York and Brussels.</p>",
      type: "image",
      width: 3606,
      height: 4164,
      index: 7
    ...
    images: [{
      ...
      url: "https://artsy-media-uploads.s3.amazonaws.com/HOLB-0lLwK5AeiupcaKYBQ%2F273+Heart+On.jpg",
      caption: "<p>Joan Snyder, <i>Heart On, </i>1975. Photo by Jack Abraham. Courtesy of the artist and The Metropolitan Museum of Art.</p>",
      type: "image",
      width: 1800,
      height: 1346,
      setTitle: null,
      ...
      url: "https://artsy-media-uploads.s3.amazonaws.com/4wrm6Xca69dAuaALUOpvjQ%2F46aeefb41b96194451214decbcd32f50.jpeg",
      caption: "<p>Harmony Hammond, <i>Duo, </i>1980. © Harmony Hammond/Licensed by VAGA via ARS, New York. Courtesy of Alexander Gray Associates, New York.</p>",
      type: "image",
      width: 1431,
      height: 1800,
      setTitle: null,
      ...
      url: "https://artsy-media-uploads.s3.amazonaws.com/01AzjBf3_d6sv3Z3x9BBgw%2FMBE010+Happy+Birthday+America.jpg",
      caption: "<p>Mary Beth Edelson, <i>Happy Birthday America,</i> 1976. Courtesy the artist and David Lewis, New York.</p>",
      type: "image",
      width: 7218,
      height: 5004,
      setTitle: null,
      ...
      url: "https://artsy-media-uploads.s3.amazonaws.com/pT-3oWIg-ZA3wQWaSv7wEQ%2FLouise+Fishman%2C+Angry+Louise.jpg",
      caption: "<p>Louise Fishman,  <i>Angry Louise, </i> 1973. © Louise Fishman. Courtesy of the artist.</p>",
      type: "image",
      width: 1800,
      height: 1164,
      setTitle: null,
    ...
    type: "text",
    body: '<p>The figures who created platforms for this work to be visible to the larger public are also lionized. Holly Solomon was a champion for what the queer 1970s had to offer. She was the first art dealer to show Mapplethorpe and embrace <a href="https://www.artsy.net/artist/thomas-lanigan-schmidt">Thomas Lanigan-Schmidt</a> with her eponymous gallery. I would get to know Holly personally in the ’80s when I began my own gallery venture with Gracie Mansion. Holly always appreciated our glitzy aesthetic. </p><h1></h1>'
  }, {
    type: "text",
    body: '<p>Judy Garland appears in the <a href="https://www.artsy.net/show/grey-art-gallery-art-after-stonewall-1969-1989">Grey Art Gallery’s iteration</a> of the show, representing the 1980s, in <em>Pride 69–’89 </em>(1989), a video by the collective DIVA TV. There’s a persistent belief that the Stonewall Riot happened because many gay folks were mourning Garland’s death. Here, she is a reminder to never forget what was lost to the generation after Stonewall. <a href="https://www.artsy.net/artist/robert-gober">Robert Gober</a>’s <em>Untitled Closet</em> (1989) announces what we could expect to discover in the ’80s: An empty closet with the door removed. After coming out in the ’70s, we were now all about being center stage, even as AIDS was killing too many of us. </p>'
  }, {
    type: "text",
    body: "<blockquote>Our passion for loving was seen as killing us, although it saved us, liberating our desires and solidifying our emotional bonds by the time AIDS arrived.</blockquote>"
  }, {
    type: "text",
    body: '<p>The queer presence in the East Village became a press magnet. They tagged it “the East Village Scene,” as if there weren’t numerous other scenes at its edges. We were flooded with talented artists and more and more places to present their work. New doors would open in the ’80s when the clubs really got going. They were certainly more familiar social settings than the West Side bars that too often didn’t welcome Black folks. Venues like Club 57, The Pyramid Club, PS 122, 8BC, La MaMa, and the Theater for a New City centered queerness. These were the places I ventured in my neighborhood. </p><p>With the introduction of these spaces, queer performance art became even more evident. John Kelly, <a href="https://www.artsy.net/artist/karen-finley">Karen Finley</a>, Tim Miller, Klaus Nomi, <a href="https://www.artsy.net/artist/keith-haring">Keith Haring</a>, and <a href="https://www.artsy.net/artist/david-mcdermott">David McDermott</a> grew out of a different scene than John Vaccaro, Charles Ludlam’s Theater of the Ridiculous, the Hot Peaches, and the Bloolips—inhabitants of the theatrical world I was introduced to when I first arrived in New York. In the ’80s, drag performers like Ethyl Eichelberger and Penny Arcade crossed over to the burgeoning <a href="https://www.artsy.net/article/artsy-editorial-history-drag-art">art world club scene</a>.</p>'
  }, {
    type: "image_collection",
    layout: "overflow_fillwidth",
    images: [{
      url: "https://artsy-media-uploads.s3.amazonaws.com/ZizcBKU4MNcb5C9zjdzxxA%2Fjds.jpg",
      caption: "<p>Jimmy DeSana, <i>Television</i>, 1978. Courtesy of the Jimmy DeSana Trust and Salon 94, New York.</p>",
      type: "image",
      width: 1261,
      height: 1872,
      index: 13
    }, {
      url: "https://artsy-media-uploads.s3.amazonaws.com/1D8PtDLZJ1VSTLp4SKtG8g%2FStephenVarbelbyGregDay007t.jpg",
      caption: "<p>Greg Day, <i>Stephen Varble at the 12th Annual NY Avant Garde Festival, </i>1975. Courtesy of the artist.</p>",
      type: "image",
      width: 579,
      height: 864,
      index: 14
    ...
    layout: "overflow_fillwidth",
    images: [{
      url: "https://artsy-media-uploads.s3.amazonaws.com/tLoxn89UmBKtIMHaO319bA%2FHappyBirthdayMarsha_06.jpg",
      caption: "<p>Sasha Wortzel and Tourmaline, <i>Happy Birthday, Marsha!</i> (film still), 2018. Courtesy of the artists.</p>",
      type: "image",
      width: 1800,
      height: 1012,
      index: 20
    ...
    type: "text",
    body: '<p>The Brooklyn venue also brings us into the experiences of the marginalized, lost, and forgotten. <a href="https://www.artsy.net/artist/lj-roberts-1">LJ Roberts</a>’s lightbox installation from 2019 is a memorial to Stormé DeLarverie. According to many eyewitnesses, DeLarverie, a butch lesbian, provoked the tussle with police that triggered the Stonewall Riots. The work calls on us to pay tribute to a figure too often lost in our remembrances.</p>'
  }, {
    type: "text",
    body: "<h1></h1>"
  }, {
    type: "text",
    body: '<p>Some things never change. Mentioned in all of the exhibitions are the <a href="https://www.artsy.net/artist/george-segal">George Segal</a> sculptures that rest in the park across from the Stonewall Inn. Many community activists have <a href="https://www.vulture.com/2018/11/is-nycs-gay-liberation-monument-too-white.html">created controversy</a> around them. As an archivist, I try to make sense of what’s evidenced and question assumptions while considering what can be discovered in attempts to fill in the gaps. </p><p>The sculptures, completed in 1979 but not installed in Christopher Park until 1992, comprise bronze casts of two pairs: one standing male couple and a seated female couple. The figures are painted white, a suggestion of the artist’s method of plaster casting by wrapping his subjects in gauze. They are described in the “Art after Stonewall” catalogue and the wall text in “Nobody Promised You Tomorrow” as whitewashing Stonewall’s legacy. This has me scratching my head. </p>'
  }, {
    type: "image_collection",
    layout: "overflow_fillwidth",
    images: [{
      url: "https://artsy-media-uploads.s3.amazonaws.com/Bf6ayX2S_tSx8mouwwbymw%2FGettyImages-916576176.jpg",
      caption: "<p>Sculptures by George Segal at Stonewall National Monument in Christopher Park, New York. Photo by Jeffrey Greenberg/UIG via Getty Images.</p>",
      type: "image",
      width: 1400,
      height: 933,
      index: 22
    ...
    type: "text",
    body: "<p>The ignorance that so many of these protesters proclaim in their “controversy” is disingenuous. The figures, who appear covered in bandages, show no implication of race. As I see it, these “bandages” are quite a fitting representation of the damage done to our community, our existence, and survival through the AIDS pandemic. To misrepresent these sculptures as disparaging to people of color seems ridiculous. People of color were so instrumental in the history of the Stonewall Uprising but many have never recognized how badly we’ve been treated by the very community we’re expected to embrace. Redressing that by protesting and implicating the sculptures as a sign of our further erasure seems like a ploy to alleviate guilt. </p>"
  }, {
    type: "image_collection",
    layout: "column_width",
    images: [{
      url: "https://artsy-media-uploads.s3.amazonaws.com/Kpyum218FlAMEB2DFQKykg%2FRolston.jpg",
      caption: "<p>Adam Rolston, <i>I Am Out Therefore I Am, </i>1989. © Adam Rolston. Courtesy of the artist.</p>",
      type: "image",
      width: 1400,
      height: 1435,
      index: 23
    ...
    type: "text",
    body: '<p>Let’s be honest here about the extent of our progress. The celebrated sculptor <a href="https://www.artsy.net/artist/louise-nevelson">Louise Nevelson</a> had originally accepted the commission before it was offered to Segal, but according to the “Art after Stonewall” catalogue, her “‘business advisors’ persuaded her that public affirmation of her lesbianism would hurt the career of her younger lover, also an artist, so she pulled out.” That’s the way the art world was then. Would the advice Nevelson’s advisors gave her be tolerated in the art world today? Is that a rhetorical question? Maybe.</p><p><br></p>'
  }]
});

exports.NonSponsoredFeatureArticle = NonSponsoredFeatureArticle;

var FeatureBasicVideoArticle = _objectSpread({}, FeatureArticle, {
  hero_section: {
    type: "basic",
    title: "What’s the Path to Winning an Art Prize?",
    url: "https://vimeo.com/238843720",
...
exports.FeatureBasicVideoArticle = FeatureBasicVideoArticle;

var tracking_tags = FeatureArticle.tracking_tags,
    UnsponsoredFeatureArticleSansTrackingTagsProp = _objectWithoutProperties(FeatureArticle, ["tracking_tags"]);

var UnsponsoredFeatureArticle = _objectSpread({}, UnsponsoredFeatureArticleSansTrackingTagsProp, {
  sponsor: {
...
exports.UnsponsoredFeatureArticle = UnsponsoredFeatureArticle;

var FeatureBasicArticle = _objectSpread({}, FeatureArticle, {
  hero_section: {
    type: "basic",
    title: "What’s the Path to Winning an Art Prize?",
    deck: "Created by graphic designer Kati Forner for a Los Angeles-based fashion retailer"
...
exports.FeatureBasicArticle = FeatureBasicArticle;
var SponsoredArticle = (0, _extend2.default)((0, _cloneDeep2.default)(FeatureArticle), _Components.Sponsor);
exports.SponsoredArticle = SponsoredArticle;
var SponsoredFeatureArticle = (0, _extend2.default)((0, _cloneDeep2.default)(NonSponsoredFeatureArticle), _Components.Sponsor);
exports.SponsoredFeatureArticle = SponsoredFeatureArticle;
var SuperArticle = (0, _extend2.default)((0, _cloneDeep2.default)(FeatureArticle), {
...
exports.SuperArticle = SuperArticle;
var ImageHeavyStandardArticle = (0, _extend2.default)((0, _cloneDeep2.default)(StandardArticle), {
  sections: [{
    type: "image_collection",
    layout: "overflow_fillwidth",
    images: [{
    ...
    type: "text",
    body: "<p>2016 was a memorable year for the world, and art along with it. Powered by data culled from Artsy as well as UBS’s Planet Art app, “The Year in Art 2016” will explore how the creative community responded to the cultural shifts and tribulations this year has seen—from the destruction of Palmyra to the proliferation of Virtual Reality to the U.S. election.</p>"
  }, {
    type: "image_collection",
    layout: "overflow_fillwidth",
    images: [{
...
exports.ShortStandardArticle = ShortStandardArticle;
var MissingVerticalStandardArticle = (0, _extend2.default)((0, _cloneDeep2.default)(StandardArticle), {
  vertical: null
}); // Articles with only text sections

exports.MissingVerticalStandardArticle = MissingVerticalStandardArticle;
var TextClassicArticle = (0, _extend2.default)((0, _cloneDeep2.default)(ClassicArticle), {
  sections: _Components.ClassicText
});
exports.TextClassicArticle = TextClassicArticle;
var TextStandardArticle = (0, _extend2.default)((0, _cloneDeep2.default)(StandardArticle), {
  sections: _Components.StandardText
});
exports.TextStandardArticle = TextStandardArticle;
var TextFeatureArticle = (0, _extend2.default)((0, _cloneDeep2.default)(FeatureArticle), {
  sections: _Components.FeatureText
});
exports.TextFeatureArticle = TextFeatureArticle;
var VideoArticle = {
  layout: "video",
  id: "597b9f652d35b80017a2a6a7",
  _id: "597b9f652d35b80017a2a6a7",
...
var VideoArticleUnpublished = (0, _extend2.default)((0, _cloneDeep2.default)(VideoArticle), {
  media: {
    title: "Trevor Paglan",
    url: "",
    duration: 4000,
...
exports.VideoArticleUnpublished = VideoArticleUnpublished;
var VideoArticleSponsored = (0, _extend2.default)((0, _cloneDeep2.default)(VideoArticle), _Components.Sponsor);
exports.VideoArticleSponsored = VideoArticleSponsored;
var SeriesArticle = {
  _id: "594a7e2254c37f00177c0ea9",
  id: "594a7e2254c37f00177c0ea9",
  layout: "series",
...
exports.SeriesArticle = SeriesArticle;
var SeriesArticleSponsored = (0, _extend2.default)((0, _cloneDeep2.default)(SeriesArticle), _Components.Sponsor);
exports.SeriesArticleSponsored = SeriesArticleSponsored;
var SeriesArticleCustomSubTitle = (0, _extend2.default)((0, _cloneDeep2.default)(SeriesArticle), {
  series: {
    sub_title: "About this Feature"
  }
});
exports.SeriesArticleCustomSubTitle = SeriesArticleCustomSubTitle;
var NewsArticle = {
  id: "594a7e2254c37f00177c0ea9",
  _id: "594a7e2254c37f00177c0ea9",
  layout: "news",
  ...
  title: "The oldest known depiction of a supernova was found in a work of 5,000 year old rock art, scientists believe.",
  sections: [{
    type: "image_collection",
    images: [{
      caption: "<p>Illustration by Tomi Um for Artsy.</p>",
