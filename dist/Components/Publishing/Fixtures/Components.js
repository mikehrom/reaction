...
exports.Artists = exports.Genes = exports.FeatureText = exports.StandardText = exports.ClassicText = exports.Videos = exports.Sponsor = exports.RelatedCanvas = exports.RelatedPanel = exports.Media = exports.ImageSetMiniSansTitle = exports.ImageSetFullSansTitle = exports.ImageSetMini = exports.ImageSetFull = exports.ImagesNarrow = exports.Images = exports.HeroSections = exports.SocialEmbedInstagram = exports.SocialEmbedTwitter = exports.Embeds = exports.StandardArticleHostedAdCanvas = exports.StandardArticleHostedAdPanel = exports.Authors = exports.Artworks = exports.ArtworkRegular = exports.ArtworkLongInfo = exports.ArtworkMultipleArtists = exports.ArtworkMissingInfo = exports.ImageCollection = void 0;
...
exports.ArtworkMissingInfo = ArtworkMissingInfo;
var ArtworkMultipleArtists = {
  type: "artwork",
  id: "589a6291275b2410d1beb6a5",
  slug: "fernando-botero-nude-on-the-beach",
  date: "2000",
...
exports.ArtworkMultipleArtists = ArtworkMultipleArtists;
var ArtworkLongInfo = {
  type: "artwork",
  id: "596aa2851a1e864d5eea6681",
  slug: "matt-devine-brass-tax",
...
exports.ArtworkLongInfo = ArtworkLongInfo;
var ArtworkRegular = {
  type: "artwork",
  id: "589a6291275b2410d1beb6a5",
  slug: "fernando-botero-nude-on-the-beach",
...
exports.ArtworkRegular = ArtworkRegular;
var Artworks = [ArtworkRegular, ArtworkMultipleArtists, ArtworkMissingInfo, ArtworkLongInfo];
...
var Authors = [{
  ...
  bio: "[Molly Gottschalk](https://artsy.net/molly) is a Features Producer at Artsy. She is a photographer and lover of cats.",
...
var StandardArticleHostedAdPanel = {
...
exports.StandardArticleHostedAdPanel = StandardArticleHostedAdPanel;
var StandardArticleHostedAdCanvas = {
...
exports.StandardArticleHostedAdCanvas = StandardArticleHostedAdCanvas;
var Embeds = [{
  mobile_height: 1300,
  height: 1000,
...
var SocialEmbedTwitter = {
  url: "https://twitter.com/artsy/status/965246051107164160",
  layout: "column_width",
  type: "social_embed"
};
exports.SocialEmbedTwitter = SocialEmbedTwitter;
var SocialEmbedInstagram = {
  url: "https://www.instagram.com/p/BfJ2TU9F6sm",
  layout: "column_width",
  type: "social_embed"
};
exports.SocialEmbedInstagram = SocialEmbedInstagram;
var HeroSections = [{
  type: "text",
...
exports.HeroSections = HeroSections;
var Images = [{
  type: "artwork",
  id: "589a6291275b2410d1beb6a5",
  slug: "fernando-botero-nude-on-the-beach",
...
var ImagesNarrow = [{
  ...
  width: 254,
  height: 1200,
  caption: "<p>Louise Bourgeois, <em>The Sky’s the Limit</em>, 1989–2003. The Museum of Modern Art, New York. © 2017 The Easton Foundation/Licensed by VAGA, NY. Courtesy of the Museum of Modern Art.</p>"
}, {
  ...
  url: "https://artsy-media-uploads.s3.amazonaws.com/3AW6ZGyyGscbswkyTqUQAw%2FScreen+Shot+2017-09-22+at+5.17.50+PM.png",
  type: "image",
  width: 598,
  height: 596,
  caption: "<p>Installation view of Louise Bourgeois, <em>Portrait of Jean-Louis</em>, 1947-49, at the Museum of Modern Art, New York. Photo by @radicchioradicchio, via Instagram.</p>"
}];
exports.ImagesNarrow = ImagesNarrow;
var ImageSetFull = {
  type: "image_set",
  layout: "full",
...
exports.ImageSetFull = ImageSetFull;
var ImageSetMini = {
  type: "image_set",
  title: "The Work of Bruce M. Sherman",
  images: Images
};
exports.ImageSetMini = ImageSetMini;
var ImageSetFullSansTitle = {
  type: "image_set",
  layout: "full",
  images: Images
};
exports.ImageSetFullSansTitle = ImageSetFullSansTitle;
var ImageSetMiniSansTitle = {
  type: "image_set",
  images: Images
};
exports.ImageSetMiniSansTitle = ImageSetMiniSansTitle;
var Media = [{
...
var RelatedPanel = [{
  ...
  thumbnail_image: "https://artsy-media-uploads.s3.amazonaws.com/4Tq-iYkN8dOpshFoKRXyYw%2Fcustom-Custom_Size___PoetterHall_Exterior+copy.jpg",
...
exports.RelatedPanel = RelatedPanel;
var RelatedCanvas = [{
  thumbnail_title: "The 15 Top Art Schools in the United States",
  thumbnail_image: "https://artsy-media-uploads.s3.amazonaws.com/4Tq-iYkN8dOpshFoKRXyYw%2Fcustom-Custom_Size___PoetterHall_Exterior+copy.jpg",
  slug: "artsy-editorial-15-top-art-schools-united-states",
...
exports.RelatedCanvas = RelatedCanvas;
var Sponsor = {
  sponsor: {
...
var ClassicText = [{
  type: "text",
  body: "<p>Rines is a part of a recent migration that has galleries gravitating to the <a href='https://www.artsy.net/'>Lower East Side and Chinatown</a>. The new gallery sits on a stretch of Henry Street that also includes Chapter NY, Cuevas Tilleard, and newcomer Shrine, and is just blocks from:</p>"
}, {
  type: "text",
  body: "<ul><li>Chinatown stalwart Reena Spaulings Fine Art</li><li>The shiny new <span style='text-decoration: line-through;'>Foxy Production</span></li><li>Freshly launched programs like Erin Goldberger’s New Release</li><li>Angelo Lanza’s gallery Jeffrey Stark in the basement of the East Broadway Mall</li></ul>"
}, {
  type: "text",
  body: "<p>And <em>not a stone’s throw away</em> are the southern bounds of the Lower East Side, where <strong>hundreds</strong> of more galleries gather.</p>"
}, {
  type: "text",
  layout: "blockquote",
  body: "<blockquote>Hardly a week goes by without murmurings that yet another gallery is opening</blockquote>"
}, {
  type: "text",
  body: "<h3><strong>Galleries Section, Booth 10221</strong></h3><h2>neugerriemschneider</h2>"
}, {
  type: "text",
  body: "<h3><em>With works by</em> Franz Ackermann, Ai Weiwei, Pawel Althamer, Billy Childish, Keith Edmier, Olafur Eliasson, Andreas Eriksson, Noa Eshkol, Mario García Torres, Renata Lucas, Michel Majerus, Mike Nelson, Jorge Pardo, Elizabeth Peyton, Tobias Rehberger, Thaddeus Strode, Rirkrit Tiravanija, Pae White</h3>"
}, {
  type: "text",
  body: "<p>The resultant work allows Salley the chance to recount her experiences of the aftermath of her scandal in her own words. In the film, Fujiwara and Salley are shown meeting professionals from public relations, advertising, and fashion companies as they seek to construct a new public image for her. Alongside the film, light boxes display fashion photographer Andreas Larsson’s pictures of Salley, which were taken as part of the project to rebuild her profile. While the show tackles public identity, female iconography, and Salley’s voice as an artist, the pair’s close working relationship—one in which the conventional power relationship has been overturned—no doubt aided their collaboration.</p>"
}, {
  type: "text",
  body: "<ol><li>Chinatown stalwart Reena Spaulings Fine Art</li><li>The shiny new Foxy Production</li><li>Freshly launched programs like Erin Goldberger’s New Release</li><li>Angelo Lanza’s gallery Jeffrey Stark in the basement of the East Broadway Mall</li></ol>"
}, {
  type: "text",
  body: "<p>Rines is a part of a recent migration that has galleries gravitating to the Lower East Side and Chinatown. She opened 56 Henry in December 2015, just four months after being forced to shutter her previous microgallery 55 Gansevoort—an elevator shaft a block east of the Whitney—after Restoration Hardware bought its building.</p>"
}, {
  type: "text",
  body: "<h2><a href='https://www.artsy.net/artist/ej-hill' class='is-follow-link' name='EJ_Hill'>EJ Hill</a><a data-id='ej-hill' class='entity-follow artist-follow'></a></h2>"
}, {
  type: "text",
  body: "<p><a href='https://www.artsy.net/artist/ej-hill' class='is-follow-link' name='EJ_Hill'>EJ Hill</a><a data-id='ej-hill' class='entity-follow artist-follow'></a></p>"
}];
exports.ClassicText = ClassicText;
var StandardText = (0, _flatten2.default)([ClassicText, {
  type: "text",
  body: "<p>Rines is a part of a recent migration that has galleries gravitating to the Lower East Side and Chinatown. She opened 56 Henry in December 2015, just four months after being forced to shutter her previous microgallery 55 Gansevoort—an elevator shaft a block east of the Whitney—after Restoration Hardware bought its building.</p>"
}]);
exports.StandardText = StandardText;
var FeatureText = (0, _flatten2.default)([{
  type: "text",
  body: "<h1>Standard Header</h1>"
}, StandardText]);
...
var Genes = [{
  gene: {
    ...
    image: {
      url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fill&width=240&height=160&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FKX6a5mdTJd5cVrqCC-yb9A%2Fthumb.jpg"
    },
...
var Artists = [{
  ...
  artist: {
    ...
    carousel: {
      images: [{
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=321&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FBnViN8O7L4qm1LF95wBxSw%2Flarge.jpg",
          width: 321,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=133&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FCtQrdlNO8F36Bo46olHNzw%2Flarge.jpg",
          width: 133,
          height: 200
        }
      }]
  ...
  artist: {
    ...
    id: "anni-albers",
    _id: "5955005ceaaedc0017acdd1f",
    blurb: "Printmaker and textile artist Anni Albers is widely recognized both for her geometric patterned compositions and deep involvement with the [Bauhaus](/gene/bauhaus) and Black Mountain College, teaching at the latter between 1933 and 1949. Albers arrived at the Bauhaus in Weimar, Germany in 1922, but was limited in the coursework she could pursue as certain disciplines were not taught to women. Although she began weaving almost by default, Albers became among the 20th century’s defining “pictorial” textile artists. At the Bauhaus she studied under painters [Paul Klee](/artist/paul-klee) and [Wassily Kandinsky](/artist/wassily-kandinsky), focusing on relationships between colors and the expressive potential of simple forms. She then married leading Bauhaus figure and renowned color theorist [Josef Albers](/artist/josef-albers) in 1925. In addition to frequent conversations with her many friends and colleagues, Albers drew inspiration from the pre-Columbian art she viewed during travels throughout Mexico and the Americas.",
    carousel: {
      images: [{
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=300&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2Fyywb0L33PlhpPIzUfvu2Sg%2Flarge.jpg",
          width: 300,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=324&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FjPPb9arcM1qqw9Fn6zMSbw%2Flarge.jpg",
          width: 324,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=154&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FxX8DYk6TSmsdRAzXAA3VVA%2Flarge.jpg",
          width: 154,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=252&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FM9rbjJsD4VoyPzI_Rein7A%2Flarge.jpg",
          width: 252,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=121&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FX3BBTgq-WcCpnvg-FbW52Q%2Flarge.jpg",
          width: 121,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=285&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FbjOpm_qN7B0XDqdnxs1wUw%2Flarge.jpg",
          width: 285,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=123&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2Fgli7IyWJ4yxCB9RVqUvhEg%2Flarge.jpg",
          width: 123,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=174&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FDeBaVbdN3cmIHXr4NUho0g%2Flarge.jpg",
          width: 174,
          height: 200
        }
      }, {
        resized: {
          url: "https://d7hftxdivxxvm.cloudfront.net?resize_to=fit&width=167&height=200&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2F0qT9YOV0Ct7fUqL43klckA%2Flarge.jpg",
          width: 167,
          height: 200
        }
      }]
