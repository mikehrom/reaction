...
export interface StepProps {
    onNextButtonPressed: (increaseBy?: any) => void;
}
...
export declare type StepSlugs = typeof Budget.slug | typeof Artists.slug | typeof Genes.slug | typeof CollectorIntent.slug | null;
