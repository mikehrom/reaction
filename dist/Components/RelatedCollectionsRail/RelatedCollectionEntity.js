...
exports.RelatedCollectionEntityFragmentContainer = exports.ArtworkImage = exports.StyledLink = exports.RelatedCollectionEntity = void 0;
...
var RelatedCollectionEntity = (_dec = (0, _Analytics.track)(), _dec2 = (0, _Analytics.track)(function (_ref) {
...
function (_React$Component) {
  _inherits(RelatedCollectionEntity, _React$Component);

  function RelatedCollectionEntity() {
    _classCallCheck(this, RelatedCollectionEntity);

    return _possibleConstructorReturn(this, _getPrototypeOf(RelatedCollectionEntity).apply(this, arguments));
  }

  _createClass(RelatedCollectionEntity, [{
    key: "onLinkClick",
  ...
  return RelatedCollectionEntity;
...
exports.RelatedCollectionEntity = RelatedCollectionEntity;
var CollectionTitle = (0, _styledComponents.default)(_palette.Serif).withConfig({
  displayName: "RelatedCollectionEntity__CollectionTitle",
  componentId: "l5i80x-0"
})(["width:max-content;"]);
var StyledLink = (0, _styledComponents.default)(_palette.Link).withConfig({
  displayName: "RelatedCollectionEntity__StyledLink",
  componentId: "l5i80x-1"
...
var SingleImgContainer = (0, _styledComponents.default)(_palette.Box).withConfig({
  displayName: "RelatedCollectionEntity__SingleImgContainer",
  componentId: "l5i80x-2"
...
var ImgOverlay = (0, _styledComponents.default)(_palette.Box).withConfig({
  displayName: "RelatedCollectionEntity__ImgOverlay",
  componentId: "l5i80x-3"
...
var ArtworkImage = _styledComponents.default.img.withConfig({
  displayName: "RelatedCollectionEntity__ArtworkImage",
  componentId: "l5i80x-4"
...
var ImgWrapper = (0, _styledComponents.default)(_palette.Flex).withConfig({
  displayName: "RelatedCollectionEntity__ImgWrapper",
  componentId: "l5i80x-5"
})(["width:262px;"]);
var RelatedCollectionEntityFragmentContainer = (0, _reactRelay.createFragmentContainer)(RelatedCollectionEntity, {
  collection: function collection() {
    var node = require("../../__generated__/RelatedCollectionEntity_collection.graphql");

    if (node.hash && node.hash !== "62656e0f6791fb5013052961265cf689") {
      console.error("The definition of 'RelatedCollectionEntity_collection' appears to have changed. Run `relay-compiler` to update the generated files to receive the expected data.");
    }

    return require("../../__generated__/RelatedCollectionEntity_collection.graphql");
  }
});
exports.RelatedCollectionEntityFragmentContainer = RelatedCollectionEntityFragmentContainer;
//# sourceMappingURL=RelatedCollectionEntity.js.map