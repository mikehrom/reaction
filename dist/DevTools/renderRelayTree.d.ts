...
import { RenderUntilPredicate } from "enzyme";
import React from "react";
import { MockRelayRendererProps } from "./MockRelayRenderer";
/**
 ...
 * tree.
 */
export declare const RelayFinishedLoading: RenderUntilPredicate<any, any, any>;
/**
 ...
 *
 */
export declare function renderRelayTree<P = {}, S = {}, C extends React.Component = React.Component>(params: MockRelayRendererProps & {
    renderUntil?: RenderUntilPredicate<P, S, C>;
    wrapper?: (renderer: JSX.Element) => JSX.Element;
}): Promise<import("enzyme").ReactWrapper<P, S, C>>;
