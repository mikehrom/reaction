...
import { Decorator, Options } from "react-tracking";
...
export interface Track<PP = {}, SS = null, AA extends Array<any> = Array<any>> {
    <P = PP, S = SS, A extends any[] = AA>(trackingInfo?: Trackables | ((props: P, state: S, args: A) => Trackables), options?: Options<Trackables>): Decorator;
}
/**
 ...
 *     ```
 */
export declare function mockTracking<P>(Subject: React.ComponentType<P>): {
