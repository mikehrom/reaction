export declare const fixFailedPaymentSuccess: {
...
export declare const fixFailedPaymentFailure: {
    commerceFixFailedPayment: {
        orderOrError: {
            error: {
                type: string;
...
export declare const fixFailedPaymentInsufficientInventoryFailure: {
    commerceFixFailedPayment: {
        orderOrError: {
            error: {
                type: string;
...
export declare const fixFailedPaymentWithActionRequired: {
    commerceFixFailedPayment: {
        orderOrError: {
            __typename: string;
            actionData: {
